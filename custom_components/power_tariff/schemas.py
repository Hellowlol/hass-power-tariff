...
DAY_SCHEMA = vol.Schema({
    ...
    vol.Optional("date", default={}): vol.All(lambda value: vad(value, DATE_SCHEMA)),
    vol.Optional("time", default={}): vol.All(lambda value: vad(value, TIME_SCHEMA)),
...
TARIFF_SCHEMA = vol.Schema({
    ...
    # So this part is kinda wired, the point that
    # Ther restrictions can be completely omitted and default config is still created.
